...
"[project]/src/utils/collectionPriceCalculator.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function calculateCollectionItemPrice(item, defaultKarat = "18K") {
    try {
        ...
        if (!descriptionHtml) {
            console.warn(`⚠️ No descriptionHtml for ${item.handle}, using fallback price: ₹${item.price}`);
        ...
        if (liElements.length === 0) {
            console.warn(`⚠️ No product specs found in description for ${item.handle}`);
            return item.price || "0.00";
        }
        // Build spec map
        const specMap = {};
        ...
        console.log(`📊 Specs for ${item.handle}:`, specMap);
        ...
        console.log(`💎 Calculating price for ${item.handle}:`, {
            diamonds,
            goldWeight,
        ...
        console.log(`✅ Calculated price for ${item.handle}: ₹${result.totalPrice}`);
        return result.totalPrice.toFixed(2);
    } catch (error) {
        console.error(`❌ Error calculating price for ${item.handle}:`, error);
        return item.price || "0.00";
    }
}
async function calculateBatchPrices(items, defaultKarat = "18K") {
    console.log(`🔄 Starting batch price calculation for ${items.length} items...`);
    const prices = {};
    ...
    console.log(`✅ Batch calculation complete!`, prices);
    return prices;
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$collectionPriceCalculator$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/collectionPriceCalculator.js [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function CollectionSection({ id, title, items = [] }) {
    ...
    const [itemPrices, setItemPrices] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({});
    const [loadingPrices, setLoadingPrices] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const loadPrices = async ()=>{
            ...
            try {
                ...
                const prices = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$collectionPriceCalculator$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateBatchPrices"])(currentItems, "18K");
                setItemPrices((prev)=>({
                        ...prev,
                        ...prices
                    }));
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "mt-auto",
                                        children: loadingPrices && !itemPrices[item.handle] ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    const fetchEarings = async ()=>{
        try {
            ...
            if (response.data?.collection?.products?.edges) {
                const transformedEarrings = transformEarringsData(response.data.collection.products.edges);
...
//# sourceMappingURL=_486cc82e._.js.map