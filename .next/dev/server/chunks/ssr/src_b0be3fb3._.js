...
function LoginPage() {
    ...
    const handleInstagramSignIn = async ()=>{
        ...
        setError("");
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$react$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signIn"])("instagram", {
                callbackUrl: "/account",
                redirect: true
            });
        } catch (error) {
