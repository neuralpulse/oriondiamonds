...
async function createCartWithCustomer(customerEmail, cartItems = []) {
    try {
        ...
        const { data } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$shopify$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["shopifyRequest"])(CREATE_CART, {
            input: {
                buyerIdentity: {
                    email: customerEmail
                },
...
async function addToExistingCart(cartId, cartItems) {
    try {
        ...
        const { data } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$shopify$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["shopifyRequest"])(ADD_CART_LINES, {
            cartId,
            lines
        });
...
async function fetchCart(cartId) {
    try {
        const { data } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$shopify$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["shopifyRequest"])(GET_CART, {
            cartId
        });
        return data.cart;
    } catch (error) {
        ...
        async function handleSync() {
            ...
            try {
                ...
                if (hasLocalItems) {
                    ...
                    const cart = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$cartSync$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["syncCartOnLogin"])(customerEmail);
                    if (cart) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].success("Cart synced successfully!", {
                            duration: 2000
                        });
                    }
                } else {
                    ...
                    const cartItems = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$cartSync$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loadCartFromShopify"])(customerEmail);
                    if (cartItems.length > 0) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].success("Cart loaded from your account!", {
                            duration: 2000
                        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a32e2417._.js.map