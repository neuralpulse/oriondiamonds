 ...
 */ const parseDescription = (description)=>{
    ...
    if (description.includes("<") && description.includes(">")) {
        try {
            ...
            const liElements = doc.querySelectorAll("ul li, .product-description ul li");
    ...
    [
        ...
        if (!specMap[key]) {
            const goldMatch = description.match(new RegExp(`${karat}\\s+Gold:\\s*([\\d.]+)`, "i"));
...
//# sourceMappingURL=_f8b1b913._.js.map