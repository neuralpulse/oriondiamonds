    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GlobalLoader.useEffect": ()=>{
            let interval = setInterval({
                "GlobalLoader.useEffect.interval": ()=>{
                    setProgress({
                        "GlobalLoader.useEffect.interval": (prev)=>{
                            if (prev >= 100) {
                                clearInterval(interval);
                                setTimeout({
                                    "GlobalLoader.useEffect.interval": ()=>setVisible(false)
                                }["GlobalLoader.useEffect.interval"], 500); // small fade delay
                                return 100;
                            }
                            return prev + 10;
                        }
            ...
            }["GlobalLoader.useEffect.interval"], 100);
            return ({
                "GlobalLoader.useEffect": ()=>clearInterval(interval)
            })["GlobalLoader.useEffect"];
        }
    }["GlobalLoader.useEffect"], []);
...
_s(GlobalLoader, "jFvKTrAec58ntZz6ye5sBjfSHGY=");
_c = GlobalLoader;
var _c;
...
//# sourceMappingURL=src_1d44f1fc._.js.map