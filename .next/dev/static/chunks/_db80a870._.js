...
"[project]/src/app/my-list/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function WishlistPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WishlistPage.useEffect": ()=>{
            ...
            const handleWishlistUpdate = {
                "WishlistPage.useEffect.handleWishlistUpdate": ()=>loadWishlist()
            }["WishlistPage.useEffect.handleWishlistUpdate"];
            window.addEventListener("wishlistUpdated", handleWishlistUpdate);
            return ({
                "WishlistPage.useEffect": ()=>window.removeEventListener("wishlistUpdated", handleWishlistUpdate)
            })["WishlistPage.useEffect"];
        }
    }["WishlistPage.useEffect"], []);
    const loadWishlist = ()=>{
    ...
    const clearWishlist = ()=>{
        if (window.confirm("Are you sure you want to clear your entire wishlist?")) {
            ...
            setWishlistItems([]);
            window.dispatchEvent(new Event("wishlistUpdated"));
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success("Wishlist cleared");
        }
    };
    const moveToCart = (item)=>{
        ...
        if (existingItemIndex > -1) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success("Quantity increased in cart");
        } else {
            const cartItem = {
...
_s(WishlistPage, "U9LhspZlyo7lzyCsm5O/Dj+ks90=", false, function() {
    return [
...
//# sourceMappingURL=_db80a870._.js.map