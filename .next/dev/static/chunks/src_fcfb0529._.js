...
"[project]/src/utils/cartCleanup.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$cartCleanup$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/cartCleanup.js [app-client] (ecmascript)");
...
function CartSyncProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CartSyncProvider.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$cartCleanup$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cleanupCart"])();
        }
    }["CartSyncProvider.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CartSyncProvider.useEffect": ()=>{
            async function handleSync() {
                ...
                try {
                    ...
                    const cleanedCart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$cartCleanup$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cleanupCart"])();
                    ...
                    if (hasLocalItems) {
                        ...
                        const mergedCart = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$cartSync$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeLocalAndMongoDBCart"])(customerEmail);
                        if (mergedCart && mergedCart.length > 0) {
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success(`Cart synced! ${mergedCart.length} item(s) in cart`, {
                                duration: 2000
                            });
                            window.dispatchEvent(new Event("cartUpdated"));
                        } else {
                        ...
                        const cartItems = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$cartSync$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadCartFromMongoDB"])(customerEmail);
                        if (cartItems && cartItems.length > 0) {
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success(`Loaded ${cartItems.length} item(s) from your cart!`, {
                                duration: 2000
                            });
                            window.dispatchEvent(new Event("cartUpdated"));
                        }
...
_s(CartSyncProvider, "r7xoGWBp/42WC0hmsOkmXbD5Wlo=", false, function() {
    return [
...
//# sourceMappingURL=src_fcfb0529._.js.map